...
//        mLastView1.setTranslationY(-(mLastView1.getHeight() / 2) * ((ratio - 0.5f) / 0.5f));
//        mLastView1.setTranslationX(-(mLastView1.getHeight() / 2) * ((ratio - 0.5f) / 0.5f));
//
//        mLastView2.setAlpha(ratio);
//        mLastView2.setTranslationY(-(mLastView2.getHeight() / 2) * ((ratio - 0.5f) / 0.5f));
//        mLastView2.setTranslationX(-(mLastView2.getHeight() / 2) * ((ratio - 0.5f) / 0.5f));
//
//
//        mLastView3.setAlpha(ratio);
//        mLastView3.setTranslationY(-(mLastView3.getHeight() / 2) * ((ratio - 0.5f) / 0.5f));
//        mLastView3.setTranslationX(-(mLastView3.getHeight() / 2) * ((ratio - 0.5f) / 0.5f));
