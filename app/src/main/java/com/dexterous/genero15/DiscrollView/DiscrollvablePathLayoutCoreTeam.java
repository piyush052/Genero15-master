 ...
 *
 */
public class DiscrollvablePathLayoutCoreTeam extends LinearLayout implements Discrollvable {

    private float mRatio;
    private Paint mPaint;
    private View mPathView;

    public DiscrollvablePathLayoutCoreTeam(Context context) {
        super(context);
        initPaint();
    }

    public DiscrollvablePathLayoutCoreTeam(Context context, AttributeSet attrs) {
        super(context, attrs);
        initPaint();
    }

    public DiscrollvablePathLayoutCoreTeam(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onFinishInflate() {
        ...
        mPathView = findViewById(R.id.core_team);
    }
