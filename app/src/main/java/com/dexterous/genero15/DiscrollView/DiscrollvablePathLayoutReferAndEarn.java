 ...
 *
 */
public class DiscrollvablePathLayoutReferAndEarn extends LinearLayout implements Discrollvable {

    private float mRatio;
    private Paint mPaint;
    private View mPathView;

    public DiscrollvablePathLayoutReferAndEarn(Context context) {
        super(context);
        initPaint();
    }

    public DiscrollvablePathLayoutReferAndEarn(Context context, AttributeSet attrs) {
        super(context, attrs);
        initPaint();
    }

    public DiscrollvablePathLayoutReferAndEarn(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onFinishInflate() {
        ...
        mPathView = findViewById(R.id.refrErn2);
    }
